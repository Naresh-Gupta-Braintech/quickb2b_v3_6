...
//   List<ProductsInventories>? inventoriesList;
...
//             ? []
//             : List<ProductsInventories>.from(json["inventoriesList"]!.map((x) => ProductsInventories.fromJson(x))),
...
//   factory ProductsInventories.fromJson(Map<String, dynamic> json) => ProductsInventories(
...
class Products {
  ...
  factory Products.fromJson(Map<String, dynamic> json) => Products(
    bannerLists: json["bannerLists"] == null ? [] : List<BannerList>.from(json["bannerLists"]!.map((x) => BannerList.fromJson(x))),
    inventoriesList:
        json["inventoriesList"] == null ? [] : List<ProductsInventories>.from(json["inventoriesList"]!.map((x) => ProductsInventories.fromJson(x))),
    multiItems: json["multi_items"] == null ? [] : List<dynamic>.from(json["multi_items"]!.map((x) => x)),
  );
...
class ProductsInventories {
  ...
  String? itemName;
  String? itemPrice;
  String? status; // ✅ Replaced enum with String
  String? uom;
  String? measureQty;
  String? originQty;
  String? quantity;
  ...
  // Controllers (for UI input fields)
  TextEditingController textEditingController1 = TextEditingController();
  TextEditingController textEditingController2 = TextEditingController();
  ...
  factory ProductsInventories.fromJson(Map<String, dynamic> json) => ProductsInventories(
    ...
    itemName: json["item_name"],
    itemPrice: json["item_price"],
    status: json["status"], // ✅ directly assign string
    uom: json["uom"],
    measureQty: json["measureQty"],
    originQty: json["originQty"],
    quantity: json["quantity"],
