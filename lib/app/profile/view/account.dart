...
class _AccountState extends State<Account> {
  ...
  Widget _customerDeatilsSection({String? acm_code, required bool isEdit, required VoidCallback onTap, required ProfileDashboardController controller}) {
    final userData = controller.userProfile;
    return Column(
      children: [
        _buildInputRow(isEdit: isEdit, "Customer ID", userData?.data?.userCode ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.customerIdController),
        _buildInputRow(isEdit: isEdit, "Business Name", userData?.data?.businessName ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.businessNameController),
        _buildInputRow(isEdit: isEdit, "First Name", userData?.data?.firstName ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.firstNameController),
        _buildInputRow(isEdit: isEdit, "Last Name", userData?.data?.lastName ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.lastNameController),
        _buildInputRow(isEdit: isEdit, "Phone", userData?.data?.phone ?? "", true, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.phoneController),
        _buildInputRow(isEdit: isEdit, "Mobile", userData?.data?.mobile ?? "", true, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.mobileController),
        _buildInputRow(isEdit: isEdit, "Email", userData?.data?.email ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.emailController),
        _buildInputRow(isEdit: isEdit, "Delivery Note", userData?.data?.deliveryNote ?? "", true, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.deliveryNoteController),
  ...
  Widget _deliveryAddressSection({required bool isEdit, required VoidCallback onTap, required ProfileDashboardController controller}) {
    ...
    return Column(
      children: [
        _buildInputRow(isEdit: isEdit, "Number/Street", userData?.data?.deliveryAddress ?? "", false, enabledTextField: true, textController: controller.deliveryStreetNumberController),
        _buildInputRow(isEdit: isEdit, "Suburb/City", userData?.data?.deliverySuburb ?? "", false, enabledTextField: true, textController: controller.deliverySuberbController),
        _buildInputRow(isEdit: isEdit, "Country", userData?.data?.deliveryCountry ?? "", false, enabledTextField: true, textController: controller.deliveryCountryController),
        _buildInputRow(isEdit: isEdit, "State/Region", userData?.data?.deliveryState ?? "", false, enabledTextField: true, textController: controller.deliveryStaterController),
        _buildInputRow(isEdit: isEdit, "Postcode/Zip", userData?.data?.deliveryPostCode ?? "", true, enabledTextField: true, textController: controller.deliveryPostalController),
        Visibility(visible: isEdit, child: _customButton(onTap: onTap)),
      ],
    );
  }

  Widget _postalAddressSection({String? acm_code, required bool isEdit, required VoidCallback onTap, required ProfileDashboardController controller}) {
    final userData = controller.userProfile;

    return Column(
      children: [
        _buildInputRow(isEdit: isEdit, "Number/Street", userData?.data?.postalAddress ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.postalStreetNumberController),
        _buildInputRow(isEdit: isEdit, "Suburb/City", userData?.data?.postalSuburb ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.postalSuberbController),
        _buildInputRow(isEdit: isEdit, "Country", userData?.data?.postalCountry ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.postalCountryController),
        _buildInputRow(isEdit: isEdit, "State/Region", userData?.data?.postalState ?? "", false, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.postalStaterController),
        _buildInputRow(isEdit: isEdit, "Postcode/Zip", userData?.data?.postalPostCode ?? "", true, enabledTextField: (acm_code != null && acm_code.isNotEmpty), textController: controller.postalPostalController),
        Visibility(visible: isEdit, child: _customButton(onTap: onTap)),
      ],
    );
  }

  Widget _buildInputRow(String label, String value, bool isNumber, {required bool enabledTextField, required bool isEdit, required TextEditingController textController}) {
