        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _section(text: "Customer Details", onTap: () => {}, buttonText: "Edit"),
              ...
              SizedBox(height: Dimensions.viewHeight16),
              _section(text: "Postal Address", onTap: () => {}, buttonText: "Edit"),
              _buildInputRow(isEditable: false, "Number/Street", "Enter Number/Street", false),
              _buildInputRow(isEditable: false, "Suburb/City", "Enter Suburb/City", false),
              _buildInputRow(isEditable: false, "Country", "Enter Country", false),
              _buildInputRow(isEditable: false, "State/Region", "Enter State/Region", false),
              ...
              Text("Delete Account", textAlign: TextAlign.right, style: TextStyle(fontFamily: TypographyResources.openSans, fontWeight: FontWeight.w700, color: Colors.red, fontSize: Dimensions.font14)),
              Text("Change Password", textAlign: TextAlign.right, style: TextStyle(fontFamily: TypographyResources.openSans, fontWeight: FontWeight.w700, color: Colors.black, fontSize: Dimensions.font14)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Padding(padding: EdgeInsets.only(left: Dimensions.padding10), child: Text(value, style: TextStyle(fontFamily: TypographyResources.openSans, color: Colors.grey, fontSize: Dimensions.font12, fontWeight: FontWeight.w600))),
