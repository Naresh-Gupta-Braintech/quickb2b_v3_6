...
Widget customCarousel({required double width, required double height, required List<BannerModel> images}) {
                ...
                builder: (BuildContext context) {
                  return Container(
                    ...
                    child: Stack(
                      fit: StackFit.expand,
                      children: [
                        cachedImageNetwork(url: banner.link ?? "", height: height, width: width, fit: BoxFit.fill),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.end,
                          // crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Padding(padding: EdgeInsets.only(left: Dimensions.padding16, right: Dimensions.padding16, bottom: Dimensions.padding16), child: HtmlWidget(banner.text ?? "")),
                            Padding(
