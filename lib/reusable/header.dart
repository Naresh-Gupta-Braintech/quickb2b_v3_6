...
Widget headerWithSearch({bool showOutlet = true, VoidCallback? onTap, bool isSearchBarFull = false, int showPrice = 1, String? rightText}) {
  return Column(
    children: [
      Padding(padding: EdgeInsets.symmetric(horizontal: 8.r), child: headers(appname: "", showPrice: showPrice ?? 0)),
      ...
      Padding(
        ...
        child: Row(
          ...
          children: [
            customSearchBar(textController: TextEditingController(), isFull: isSearchBarFull),
